Учебный проект для курса, использующийся в качестве примера на созвонах. Создан исключительно для целей обучения моих студентов и использования на групповых созвонах.
